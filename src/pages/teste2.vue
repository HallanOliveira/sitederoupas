...
<q-page>
    <div>
 <p class="row text-h2 justify-center q-mt-lg q-mb-lg text-pink-10"><strong>Estoque</strong></p>
...
<q-btn type="a" href="https://api.whatsapp.com/send/?phone=5541997867176&text&app_absent=0" target="_blank" id="btn1" class="bg-green-6 glossy text-white shadow-3">
...
export default {
  ...
  data () {
     return { 
      current: 1,
      posts:[],
      URL: 'https://super.abril.com.br/wp-content/uploads/2012/03/por-que-medidas-de-roupas-nacc83o-sacc83o-padronizadas.jpg',
      v1: 0,
      v2: 12,
...
return this.v1 = (this.current * 12) - 12, this.v2 = (this.current * 12) 
  ...
  aplicar(){
    if(this.aplicarsombrear == true){
      return this.sombrear = 'shadow-up-24'
    }else if(this.aplicarsombrear == false){
      return this.sombrear = ''
    }
  }
}
}
